...
/**
 * Predefined value-formatter that formats large numbers in a pretty way. Outputs: 856 = 856; 1000 =
 * 1k; 5821 = 5.8k; 10500 = 10k; 101800 = 102k; 2000000 = 2m; 7800000 = 7.8m; 92150000 = 92m;
 * 123200000 = 123m; 9999999 = 10m; 1000000000 = 1b; Special thanks to Roman Gromov
...
class LargeValueFormatter() : IValueFormatter, IAxisValueFormatter {
  ...
  /**
   * Formats each number properly. Special thanks to Roman Gromov (https://github.com/romangromov)
