...
interface ILineDataSet : ILineRadarDataSet<Entry> {
  ...
  /**
   * Returns the intensity of the cubic lines (the effect intensity). Max = 1f = very cubic, Min =
  ...
  @get:Deprecated("") val isDrawCubicEnabled: Boolean

  @get:Deprecated("") val isDrawSteppedEnabled: Boolean
