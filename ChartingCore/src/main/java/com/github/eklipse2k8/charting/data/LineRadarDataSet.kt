...
import com.github.eklipse2k8.charting.interfaces.datasets.ILineRadarDataSet
...
abstract class LineRadarDataSet<T : Entry>(yVals: MutableList<T>, label: String?) :
  ...
  @set:TargetApi(18) override var fillDrawable: Drawable? = null
  /**
   * sets the alpha value (transparency) that is used for filling the line surface (0-255), default:
   * 85
   *
   * @param alpha
   */
  ...
  /**
   * set the line width of the chart (min = 0.2f, max = 10f); default 1f NOTE: thinner line ==
