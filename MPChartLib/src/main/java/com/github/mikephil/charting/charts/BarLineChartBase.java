...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void init() {
        ...
        mBorderPaint.setStrokeWidth(Utils.INSTANCE.convertDpToPixel(1f));
    }
    ...
    public void zoomAndCenterAnimated(float scaleX, float scaleY, float xValue, float yValue, AxisDependency axis,
        ...
        Runnable job = AnimatedZoomJob.Companion.getInstance(mViewPortHandler, this, getTransformer(axis), getAxis(axis), mXAxis
    ...
    public void moveViewToX(float xValue) {
        ...
        Runnable job = MoveViewJob.Companion.getInstance(mViewPortHandler, xValue, 0f,
    ...
    public void moveViewTo(float xValue, float yValue, AxisDependency axis) {
        ...
        Runnable job = MoveViewJob.Companion.getInstance(mViewPortHandler, xValue, yValue + yInView / 2f,
    ...
    public void moveViewToAnimated(float xValue, float yValue, AxisDependency axis, long duration) {
        ...
        Runnable job = AnimatedMoveViewJob.Companion.getInstance(mViewPortHandler, xValue, yValue + yInView / 2f,
    ...
    public void centerViewToY(float yValue, AxisDependency axis) {
        ...
        Runnable job = MoveViewJob.Companion.getInstance(mViewPortHandler, 0f, yValue + valsInView / 2f,
                getTransformer(axis), this);
    ...
    public void centerViewTo(float xValue, float yValue, AxisDependency axis) {
        ...
        Runnable job = MoveViewJob.Companion.getInstance(mViewPortHandler,
    ...
    public void centerViewToAnimated(float xValue, float yValue, AxisDependency axis, long duration) {
        ...
        Runnable job = AnimatedMoveViewJob.Companion.getInstance(mViewPortHandler,
                xValue - xInView / 2f, yValue + yInView / 2f,
                getTransformer(axis), this, (float) bounds.x, (float) bounds.y, duration);
    ...
    public void setBorderWidth(float width) {
        mBorderPaint.setStrokeWidth(Utils.INSTANCE.convertDpToPixel(width));
    }
