 ...
 */
open class Transformer(@JvmField protected var mViewPortHandler: ViewPortHandler) {
  ...
  open fun prepareMatrixOffset(inverted: Boolean) {
    ...
    if (!inverted)
      ...
      offsetMatrix.setTranslate(mViewPortHandler.offsetLeft(), -mViewPortHandler.offsetTop())
