...
object Easing {
  ...
  val EaseInSine: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          return (-Math.cos(input * (Math.PI / 2f))).toFloat() + 1f
        }
      }
  val EaseOutSine: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          return Math.sin(input * (Math.PI / 2f)).toFloat()
        }
      }
  val EaseInOutSine: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          return -0.5f * (Math.cos(Math.PI * input).toFloat() - 1f)
        }
      }
  val EaseInExpo: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          return if (input == 0f) 0f else Math.pow(2.0, (10f * (input - 1f)).toDouble()).toFloat()
        }
      }
  val EaseOutExpo: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          return if (input == 1f) 1f
          else (-Math.pow(2.0, (-10f * (input + 1f)).toDouble())).toFloat()
        }
      }
  ...
  val EaseInCirc: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          return -(Math.sqrt((1f - input * input).toDouble()).toFloat() - 1f)
        }
      }
  val EaseOutCirc: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          var input = input
          input--
  ...
  val EaseInOutCirc: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          var input = input
          input *= 2f
  ...
  val EaseOutElastic: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          ...
          val s = p / DOUBLE_PI * Math.asin(1.0).toFloat()
          return (1f +
              Math.pow(2.0, (-10f * input).toDouble()).toFloat() *
                  Math.sin(((input - s) * DOUBLE_PI / p).toDouble()).toFloat())
        }
      }
                  ...
                  (0.5f *
                      Math.pow(
                              ...
                              (-10f *
                                  ...
                                  .toDouble())
                          .toFloat() *
                      Math.sin(((input * 1f - s) * DOUBLE_PI * p).toDouble()).toFloat())
        }
      }
  ...
  val EaseOutBack: EasingFunction =
      object : EasingFunction {
        override fun getInterpolation(input: Float): Float {
          var input = input
          val s = 1.70158f
